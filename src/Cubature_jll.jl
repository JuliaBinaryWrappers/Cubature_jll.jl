...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Cubature_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7bc98958-0e37-5d67-a6ac-a3a19030071a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Cubature", artifacts_toml) for e in artifacts["Cubature"]]
...
if best_platform === nothing
    @debug("Unable to load Cubature; unsupported platform $(triplet(platform_key_abi()))")
else
